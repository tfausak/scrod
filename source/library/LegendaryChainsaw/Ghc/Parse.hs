...
module LegendaryChainsaw.Ghc.Parse where
...
import qualified LegendaryChainsaw.Ghc.DynFlags as DynFlags
import qualified LegendaryChainsaw.Ghc.OnOff as OnOff
import qualified LegendaryChainsaw.Ghc.ParserOpts as ParserOpts
